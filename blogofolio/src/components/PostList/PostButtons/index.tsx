        ...
        <button className={`${styles.LikeButton} ${likeActive ? `${styles.likeActive}` : ''}`} onClick={LikeCount}  >
            <svg
                ...
                < path fill-rule="evenodd"
                    ...
                    fill={likeActive ? `${"#5360CD"}` : `${themeColor === 'light' ? '#313037' : '#FFFFFF'}`}
                />
            </svg>
        </button>
        ...
        <button className={`${styles.DislikeButton} ${dislikeActive ? `${styles.dislikeActive}` : ''}`} onClick={DislikeCount}>
            <svg width="23"
                ...
                <path fill-rule="evenodd"
                    ...
                    fill={dislikeActive ? `${"#ff0000"}` : `${themeColor === 'light' ? '#313037' : '#FFFFFF'}`}
                />
            </svg>
            ...
            <button onClick={ChangeBg} className={`${styles.FavoriteButton} ${favActive ? `${styles.favActive}` : ''}`}>
                <svg width="24"
                    ...
                    <path
                        ...
                        fill={favActive ? `${"#5360CD"}` : `${themeColor === 'light' ? '#313037' : '#FFFFFF'}`}
                    />
                </svg>
            </button>
            ...
            <button >
                <svg width="20"
                    ...
                    <path
                        ...
                        fill={themeColor === 'light' ? '#313037' : '#FFFFFF'}
                    />
                </svg>
